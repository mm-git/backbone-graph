...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graph = {
	  ...
	  LineData: __webpack_require__(8),
	  PointData: __webpack_require__(10),
	  Point: __webpack_require__(9),
	  GraphView: __webpack_require__(11)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  var Backbone, GraphData, GraphDataCollection,
	  ...
	  GraphData = __webpack_require__(7);

	  GraphDataCollection = (function(superClass) {
	    extend(GraphDataCollection, superClass);

	    function GraphDataCollection() {
	      return GraphDataCollection.__super__.constructor.apply(this, arguments);
	    }

	    GraphDataCollection.prototype.model = GraphData;

	    GraphDataCollection.property("xMax", {
	      get: function() {
	        return Math.max.apply(null, this.map(function(model) {
	          return model.xMax;
	        }));
	      }
	    });

	    GraphDataCollection.property("yMax", {
	      get: function() {
	        return Math.max.apply(null, this.map(function(model) {
	          return model.max.y;
	        }));
	    ...
	    GraphDataCollection.prototype.change = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, GraphData,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;

	  Backbone = __webpack_require__(4);

	  GraphData = (function(superClass) {
	    extend(GraphData, superClass);

	    function GraphData() {
	      return GraphData.__super__.constructor.apply(this, arguments);
	    }
	    ...
	    GraphData.prototype.initialize = function(options) {
	    ...
	    GraphData.property("type", {
	      get: function() {
	        return this.get('type');
	      }
	    });

	    GraphData.property("pointList", {
	      get: function() {
	        return this._pointList;
	      }
	    });

	    GraphData.property("min", {
	      get: function() {
	        return this._min;
	      }
	    });

	    GraphData.property("max", {
	      get: function() {
	        return this._max;
	      }
	    });

	    GraphData.property("xMax", {
	      get: function() {
	        if (this._pointList.length === 0) {
	          return 0;
	        }
	        return this._pointList[this._pointList.length - 1].x;
	      }
	    });
	    ...
	    GraphData.prototype.addPoint = function(point) {
	      this._pointList.push(point);
	      if (this._pointList.length === 1) {
	        this._min = point;
	        return this._max = point;
	      } else {
	        if (this._min.y > point.y) {
	          this._min = point;
	        }
	        if (this._max.y < point.y) {
	          return this._max = point;
	        }
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var GraphData, GraphLineData, GraphPoint, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  GraphPoint = __webpack_require__(9);

	  GraphLineData = (function(superClass) {
	    extend(GraphLineData, superClass);

	    function GraphLineData() {
	      return GraphLineData.__super__.constructor.apply(this, arguments);
	    }

	    GraphLineData.prototype["default"] = {
	      lineColor: "#ffcc00",
	      peakColor: "#ff0000"
	    };

	    GraphLineData.prototype.initialize = function(options) {
	      GraphLineData.__super__.initialize.call(this, options);
	      this.set('type', GraphData.TYPE.LINE);
	      this._smoothList = [];
	      this._peakList = [];
	    ...
	    GraphLineData.property("peakColor", {
	      get: function() {
	        return this.get('peakColor');
	      }
	    });

	    GraphLineData.property("pointList", {
	      get: function() {
	        if (this._smoothList.length > 0) {
	          return this._smoothList;
	        }
	        return this._pointList;
	      }
	    });

	    GraphLineData.property("peakList", {
	      get: function() {
	        return this._peakList;
	      }
	    });
	    ...
	    GraphLineData.prototype.smooth = function(interval, range, xyRatio, threshold) {
	      ...
	      return this._threshold = threshold;
	    };
	    ...
	    GraphLineData.prototype.unsmooth = function() {
	      ...
	      this._smoothStatistics = {};
	      return this._rangeStatistics = {
	        start: this._rangeStatistics.start,
	        end: this._rangeStatistics.end,
	        selected: this._rangeStatistics.selected
	      };
	    };
	    ...
	    GraphLineData.prototype._reSampling = function(interval, range) {
	      ...
	      this._smoothList = [];
	      for (index = j = 0, ref1 = newPointList.length; 0 <= ref1 ? j < ref1 : j > ref1; index = 0 <= ref1 ? ++j : --j) {
	        start = index - range > 0 ? index - range : 0;
	        end = index + range < newPointList.length ? index + range : newPointList.length - 1;
	        yTotal = 0;
	        for (rangeIndex = k = ref2 = start, ref3 = end; ref2 <= ref3 ? k <= ref3 : k >= ref3; rangeIndex = ref2 <= ref3 ? ++k : --k) {
	          yTotal += newPointList[rangeIndex].y;
	        }
	        this._smoothList.push(new GraphPoint(newPointList[index].x, yTotal / (end - start + 1)));
	      }
	    };
	    ...
	    GraphLineData.prototype._calculatePeak = function(start, end, xyRatio, threshold) {
	      ...
	      for (index = i = ref = start, ref1 = end; ref <= ref1 ? i < ref1 : i > ref1; index = ref <= ref1 ? ++i : --i) {
	        ...
	        if (this._smoothList[maxIndex].y < this._smoothList[index].y) {
	          maxIndex = index;
	        }
	    ...
	    GraphLineData.prototype.getAutoRange = function(x) {
	      ...
	      this._peakList.some((function(_this) {
	        return function(peak, index) {
	          if (peak.point.x > x || index === _this._peakList.length - 1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  GraphPoint = (function() {
	    function GraphPoint(_x, _y) {
	      this._x = _x;
	      this._y = _y;
	    }

	    GraphPoint.property("x", {
	      get: function() {
	        return this._x;
	      },
	      set: function(x) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var GraphData, GraphPointData, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  GraphPointData = (function(superClass) {
	    extend(GraphPointData, superClass);

	    function GraphPointData() {
	      return GraphPointData.__super__.constructor.apply(this, arguments);
	    }

	    GraphPointData.SHAPE = {
	      CIRCLE: 1,
	      DOWNWARD_TRIANGLE: 2,
	      TRIANGLE: 3,
	      SQUARE: 4,
	    ...
	    GraphPointData.prototype["default"] = {
	      pointColor: "#ff3333",
	      pointShape: GraphPointData.SHAPE.DOWNWARD_TRIANGLE
	    };

	    GraphPointData.prototype.initialize = function(options) {
	      GraphPointData.__super__.initialize.call(this, options);
	      this.set('type', GraphData.TYPE.POINT);
	      return this._attributeList = [];
	    };

	    GraphPointData.property("pointColor", {
	      get: function() {
	        return this.get('pointColor');
	      }
	    });

	    GraphPointData.property("pointShape", {
	      get: function() {
	        return this.get('pointShape');
	      }
	    });

	    GraphPointData.property("attributeList", {
	      get: function() {
	        return this._attributeList;
	      }
	    });
	    ...
	    GraphPointData.prototype.addPoint = function(point, color, shape) {
	      ...
	      return this._attributeList.push({
	        color: color || this.pointColor,
	        shape: shape || this.pointShape
	      });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  XAxisView = __webpack_require__(12);
	  ...
	  RangeView = __webpack_require__(22);

	  GestureView = __webpack_require__(23);

	  ScaleData = __webpack_require__(24);

	  OffsetData = __webpack_require__(25);

	  RangeData = __webpack_require__(26);

	  AxisData = __webpack_require__(27);

	  RectRegion = __webpack_require__(28);

	  GestureData = __webpack_require__(29);
	  ...
	  GraphView = (function(superClass) {
	    ...
	    GraphView.prototype.initialize = function(options) {
	      ...
	      this._xAxisData = new AxisData(this.xAxis);
	      this._yAxisData = new AxisData(this.yAxis);
	      this._xScaleData = new ScaleData({
	        title: "X"
	      });
	      this._yScaleData = new ScaleData({
	        title: "Y"
	      });
	      this._xOffsetData = new OffsetData({
	        width: this.width - GraphView.ORIGIN_OFFSET_X,
	        scale: this._xScaleData
	      });
	      this._xRangeData = new RangeData({
	        width: this.width - GraphView.ORIGIN_OFFSET_X,
	        scale: this._xScaleData,
	        axis: this._xAxisData,
	        offset: this._xOffsetData,
	        targetGraph: this.collection.models[0],
	        rangeColor: this.range.color,
	        rangeOpacity: this.range.opacity
	      });
	      this.render();
	      this._registerEvent();
	      return this._registerDefaultGesture();
	    };

	    GraphView.prototype.render = function() {
	      this._yAxisView = new YAxisView({
	        model: this._yAxisData,
	        pos: [0, 0, GraphView.ORIGIN_OFFSET_X, this.height - GraphView.ORIGIN_OFFSET_Y],
	        yScale: this._yScaleData
	      });
	      this._yAxisView.$wrap.appendTo(this.$el);
	      this._graphCanvasView = new GraphCanvasView({
	        collection: this.collection,
	        pos: [GraphView.ORIGIN_OFFSET_X, 0, this.width - GraphView.ORIGIN_OFFSET_X, this.height - GraphView.ORIGIN_OFFSET_Y],
	        xAxis: this._xAxisData,
	        yAxis: this._yAxisData,
	        xScale: this._xScaleData,
	        yScale: this._yScaleData,
	        xOffset: this._xOffsetData
	      });
	      this._graphCanvasView.$wrap.appendTo(this.$el);
	      this._xAxisView = new XAxisView({
	        model: this._xAxisData,
	        pos: [GraphView.ORIGIN_OFFSET_X, this.height - GraphView.ORIGIN_OFFSET_Y, this.width - GraphView.ORIGIN_OFFSET_X, GraphView.ORIGIN_OFFSET_Y],
	        xScale: this._xScaleData,
	        xOffset: this._xOffsetData
	      });
	      this._xAxisView.$wrap.appendTo(this.$el);
	      this._rangeView = new RangeView({
	        model: this._xRangeData,
	        pos: [GraphView.ORIGIN_OFFSET_X, 0, this.width - GraphView.ORIGIN_OFFSET_X, this.height - GraphView.ORIGIN_OFFSET_Y],
	        xAxis: this._xAxisData,
	        xScale: this._xScaleData,
	        xOffset: this._xOffsetData
	      });
	      this._rangeView.$wrap.appendTo(this.$el);
	      this._xScaleChangeView = new ScaleChangeView({
	        model: this._xScaleData
	      });
	      this._xScaleChangeView.$el.appendTo(this.$el);
	      this.$el.css({
	        left: 0,
	        top: 0,
	        width: this.width,
	    ...
	    GraphView.prototype._registerEvent = function() {
	      this.listenTo(this.collection, "change", (function(_this) {
	        return function() {
	          _this._xAxisData.max = _this.collection.xMax;
	          _this._yAxisData.max = _this.collection.yMax;
	          _this._yAxisView.render();
	      ...
	      return this.listenTo(this._xRangeData, "change", (function(_this) {
	        return function() {
	          return _this._rangeView.render();
	        };
	      })(this));
	    };
	    ...
	    GraphView.prototype._registerDefaultGesture = function() {
	      ...
	      rangeGesture = new GestureData({
	        ...
	        dragStart: (function(_this) {
	          return function(mousePos) {
	            return _this._xRangeData.selectStartX(mousePos.currentPos.x - GraphView.ORIGIN_OFFSET_X);
	          };
	        })(this),
	      ...
	      return this._gestureView = new GestureView({
	        el: this.$el,
	        collection: this._gestureCollection
	      });
	    };
	            ...
	            repeat: (function(_this) {
	              return function(mousePos, index) {
	                if (index === 0) {
	                  ...
	                  if (_this._xRangeData.end < _this._xAxisData.max) {
	                    _this._xOffsetData.scroll(-GraphView.SCROLL_WIDTH);
	                    return _this._xRangeData.shiftX(mousePos.differencePos.x + GraphView.SCROLL_WIDTH);
	                  }
	                }
	          ...
	          if (subView instanceof GraphPointView) {
	            return subView.drawPointList.forEach(function(drawPoint, index) {
	              ...
	              if (_this._rangeRegion.isInside(drawPoint.x + GraphView.ORIGIN_OFFSET_X + _this._xOffsetData.offset, drawPoint.y)) {
	                pointRegion = new RectRegion(drawPoint.x + GraphView.ORIGIN_OFFSET_X + _this._xOffsetData.offset - 5, drawPoint.y - 7, drawPoint.x + GraphView.ORIGIN_OFFSET_X + _this._xOffsetData.offset + 5, drawPoint.y + 7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var CanvasView, XAxisView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;

	  __ = __webpack_require__(5);

	  CanvasView = __webpack_require__(13);

	  XAxisView = (function(superClass) {
	    var _axisOptions;

	    extend(XAxisView, superClass);

	    function XAxisView() {
	      return XAxisView.__super__.constructor.apply(this, arguments);
	    }

	    _axisOptions = ['xScale', 'xOffset'];

	    XAxisView.prototype.initialize = function(options) {
	      XAxisView.__super__.initialize.call(this, options);
	      __.extend(this, __.pick(options, _axisOptions));
	      return this.render();
	    };

	    XAxisView.prototype.render = function() {
	      var GraphView, adjustXInterval, context, drawSub, h, i, ref, ref1, ref2, w, x, xe, xp, xs, ye, ys;
	      w = this.pos[2] * this.xScale.scale / 100;
	      h = this.pos[3];
	      this.$el.css({
	        position: "relative",
	        left: this.xOffset.offset,
	        top: 0,
	        width: w,
	        height: h
	      });
	      ...
	      context.fillStyle = this.model.axisColor;
	      ...
	      context.textBaseline = "bottom";
	      adjustXInterval = this.xScale.adjustInterval;
	      drawSub = (xs + (xe - xs) * this.model.subInterval / (this.model.max * adjustXInterval)) > 40;
	    ...
	    XAxisView.prototype.scrollX = function() {
	      return this.$el.css({
	        left: this.xOffset.offset
	      });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, CanvasView, HiddenView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  HiddenView = __webpack_require__(14);
	  ...
	  CanvasView = (function(superClass) {
	    ...
	    CanvasView.prototype.initialize = function(options) {
	      __.extend(this, __.pick(options, _canvasOptions));
	      this._wrap = new HiddenView({
	        pos: this.pos
	      });
	      return this._wrap.$el.append(this.$el);
	    };

	    CanvasView.property("$wrap", {
	      get: function() {
	        return this._wrap.$el;
	      }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, HiddenView,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;

	  Backbone = __webpack_require__(4);

	  HiddenView = (function(superClass) {
	    extend(HiddenView, superClass);

	    function HiddenView() {
	      return HiddenView.__super__.constructor.apply(this, arguments);
	    }

	    HiddenView.prototype.tagName = "div";

	    HiddenView.prototype.initialize = function(options) {
	      return this.$el.css({
	        overflow: "hidden",
	        position: "absolute",
	        left: options.pos[0],
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  YAxisView = (function(superClass) {
	    var _axisOptions;

	    extend(YAxisView, superClass);

	    function YAxisView() {
	      return YAxisView.__super__.constructor.apply(this, arguments);
	    }

	    _axisOptions = ['yScale'];

	    YAxisView.prototype.initialize = function(options) {
	      YAxisView.__super__.initialize.call(this, options);
	      __.extend(this, __.pick(options, _axisOptions));
	      return this.render();
	    };

	    YAxisView.prototype.render = function() {
	      var GraphView, adjustXInterval, context, drawSub, h, i, ref, ref1, ref2, w, xe, xs, y, ye, yp, ys;
	      w = this.pos[2];
	      h = this.pos[3] * this.yScale.scale / 100;
	      this.$el.css({
	        position: "relative",
	        left: 0,
	        top: 0,
	      ...
	      adjustXInterval = this.yScale.adjustInterval;
	      drawSub = (ye + (ys - ye) * this.model.subInterval / this.model.max * adjustXInterval) > 50;
	      for (y = i = ref = this.model.subInterval / adjustXInterval, ref1 = this.model.max, ref2 = this.model.subInterval / adjustXInterval; ref2 > 0 ? i <= ref1 : i >= ref1; y = i += ref2) {
	        yp = ys + (ye - ys) * y / this.model.max;
	        if (y % this.model.interval === 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var CanvasView, GraphCanvasView, GraphData, GraphLineView, GraphPointView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  GraphLineView = __webpack_require__(17);

	  GraphPointView = __webpack_require__(18);

	  GraphCanvasView = (function(superClass) {
	    var _graphCanvasOptions;

	    extend(GraphCanvasView, superClass);
	    ...
	    GraphCanvasView.prototype.render = function() {
	      var GraphView, context, h, w, xe, xs, ye, ys;
	      w = this.pos[2] * this.xScale.scale / 100;
	      h = this.pos[3] * this.yScale.scale / 100;
	      this.$el.css({
	        position: "relative",
	    ...
	    GraphCanvasView.prototype._drawAxis = function(context, xs, xe, ys, ye) {
	      ...
	      for (x = i = 0, ref = this.xAxis.max, ref1 = this.xAxis.interval / this.xScale.adjustInterval; ref1 > 0 ? i <= ref : i >= ref; x = i += ref1) {
	        xp = xs + (xe - xs) * x / this.xAxis.max;
	        context.beginPath();
	        context.moveTo(xp, ys);
	        context.lineTo(xp, ye);
	        context.stroke();
	      }
	      context.strokeStyle = this.yAxis.axisColor;
	      context.fillStyle = this.yAxis.axisColor;
	      results = [];
	      for (y = j = 0, ref2 = this.yAxis.max, ref3 = this.yAxis.interval / this.yScale.adjustInterval; ref3 > 0 ? j <= ref2 : j >= ref2; y = j += ref3) {
	        yp = ys + (ye - ys) * y / this.yAxis.max;
	        context.beginPath();
	    ...
	    GraphCanvasView.prototype.scrollX = function() {
	      return this.$el.css({
	        left: this.xOffset.offset
	      });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  GraphLineView = (function(superClass) {
	    var _graphLineOptions;

	    extend(GraphLineView, superClass);

	    function GraphLineView() {
	      return GraphLineView.__super__.constructor.apply(this, arguments);
	    }

	    _graphLineOptions = ['xAxis', 'yAxis'];

	    GraphLineView.prototype.initialize = function(options) {
	      return __.extend(this, __.pick(options, _graphLineOptions));
	    };

	    GraphLineView.prototype.render = function() {
	      var GraphView, context, h, w, xe, xs, ye, ys;
	      GraphView = __webpack_require__(11);
	      context = this.$el[0].getContext('2d');
	      w = this.$el[0].width;
	      ...
	      ys = h;
	      ye = GraphView.ORIGIN_OFFSET_Y;
	      this._drawLine(context, xs, xe, ys, ye);
	      return this._drawPeak(context, xs, xe, ys, ye);
	    };
	    ...
	    GraphLineView.prototype._drawLine = function(context, xs, xe, ys, ye) {
	      ...
	      context.strokeStyle = this.model.lineColor;
	      context.fillStyle = this.model.lineColor;
	      context.beginPath();
	      ...
	      this.model.pointList.forEach((function(_this) {
	        return function(point, index) {
	          if (index > 0) {
	            xp = xs + (xe - xs) * point.x / _this.xAxis.max;
	            yp = ys + (ye - ys) * point.y / _this.yAxis.max;
	            return context.lineTo(xp, yp);
	          }
	        };
	      })(this));
	    ...
	    GraphLineView.prototype._drawPeak = function(context, xs, xe, ys, ye) {
	      if (this.model.peakList.length === 0) {
	        return;
	      }
	      context.fillStyle = this.model.peakColor;
	      return this.model.peakList.forEach((function(_this) {
	        return function(peak) {
	          var xp, yp;
	          xp = xs + (xe - xs) * peak.point.x / _this.xAxis.max;
	          yp = ys + (ye - ys) * peak.point.y / _this.yAxis.max;
	          context.beginPath();
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, GraphPointData, GraphPointView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  GraphPointData = __webpack_require__(10);

	  GraphPointView = (function(superClass) {
	    var _graphPointOptions;

	    extend(GraphPointView, superClass);

	    function GraphPointView() {
	      return GraphPointView.__super__.constructor.apply(this, arguments);
	    }
	    ...
	    GraphPointView.prototype.render = function() {
	      ...
	      ys = h;
	      ye = GraphView.ORIGIN_OFFSET_Y;
	      return this._drawPoint(context, xs, xe, ys, ye);
	    };
	    ...
	    GraphPointView.prototype._drawPoint = function(context, xs, xe, ys, ye) {
	      ...
	      return this.model.pointList.forEach((function(_this) {
	        return function(point, index) {
	          var xp, yp;
	          context.fillStyle = _this.model.attributeList[index].color;
	          xp = xs + (xe - xs) * point.x / _this.xAxis.max;
	          yp = ys + (ye - ys) * point.y / _this.yAxis.max;
	          switch (_this.model.attributeList[index].shape) {
	            case GraphPointData.SHAPE.CIRCLE:
	              context.beginPath();
	              context.arc(xp, yp, 4, 0, Math.PI * 2, false);
	              context.fill();
	              break;
	            case GraphPointData.SHAPE.DOWNWARD_TRIANGLE:
	              context.beginPath();
	              ...
	              context.fill();
	              break;
	            case GraphPointData.SHAPE.TRIANGLE:
	              context.beginPath();
	              context.moveTo(xp - 5, yp + 7);
	              context.lineTo(xp + 5, yp + 7);
	              context.lineTo(xp, yp);
	              context.fill();
	              break;
	            case GraphPointData.SHAPE.SQUARE:
	              context.beginPath();
	              context.fillRect(xp - 4, yp - 4, 8, 8);
	              break;
	            case GraphPointData.SHAPE.DIAMOND:
	              context.beginPath();
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, ScaleButtonView, ScaleChangeView, ScaleNumberView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  ScaleButtonView = __webpack_require__(20);

	  ScaleNumberView = __webpack_require__(21);

	  ScaleChangeView = (function(superClass) {
	    extend(ScaleChangeView, superClass);

	    function ScaleChangeView() {
	      return ScaleChangeView.__super__.constructor.apply(this, arguments);
	    }

	    ScaleChangeView.prototype.tagName = "div";

	    ScaleChangeView.prototype.className = "backbone_graph_scale backbone_graph_scale_private";

	    ScaleChangeView.prototype.initialize = function(options) {
	      return this.render();
	    };

	    ScaleChangeView.prototype.render = function() {
	      this.$el.append(new ScaleButtonView({
	        click: ((function(_this) {
	          return function() {
	      ...
	      this.$el.append(new ScaleNumberView({
	        model: this.model
	      }).$el);
	      this.$el.append(new ScaleButtonView({
	        click: ((function(_this) {
	    ...
	    ScaleChangeView.prototype._zoomOut = function() {
	      return this.model.zoomOut();
	    };

	    ScaleChangeView.prototype._zoomIn = function() {
	      return this.model.zoomIn();
	    };

	    return ScaleChangeView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, ScaleButtonView, __,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  ScaleButtonView = (function(superClass) {
	    extend(ScaleButtonView, superClass);

	    function ScaleButtonView() {
	      return ScaleButtonView.__super__.constructor.apply(this, arguments);
	    }

	    ScaleButtonView.prototype.tagName = "button";

	    ScaleButtonView.prototype.className = "backbone_graph_scale_button backbone_graph_scale_button_private";

	    ScaleButtonView.prototype.events = {
	      click: "_onClick"
	    };

	    ScaleButtonView.prototype.initialize = function(options) {
	      __.bindAll(this, "_onClick");
	      this._value = options.value;
	      this._click = options.click;
	      return this.render();
	    };

	    ScaleButtonView.prototype.render = function() {
	      this.$el.html(this._value);
	      return this;
	    };

	    ScaleButtonView.prototype._onClick = function() {
	      return this._click();
	    };

	    return ScaleButtonView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, ScaleNumberView,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;

	  Backbone = __webpack_require__(4);

	  ScaleNumberView = (function(superClass) {
	    extend(ScaleNumberView, superClass);

	    function ScaleNumberView() {
	      return ScaleNumberView.__super__.constructor.apply(this, arguments);
	    }

	    ScaleNumberView.prototype.tagName = "input";

	    ScaleNumberView.prototype.className = "backbone_graph_scale_number backbone_graph_scale_number_private";

	    ScaleNumberView.prototype.initialize = function(options) {
	    ...
	    ScaleNumberView.prototype.render = function() {
	      this.$el.attr({
	        type: "text",
	        readonly: "",
	        draggable: false
	      }).val(this.model.title + " : " + this.model.scale + "%");
	      return this;
	    };

	    return ScaleNumberView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  RangeView = (function(superClass) {
	    var _rangeOptions;

	    extend(RangeView, superClass);
	    ...
	    RangeView.prototype.initialize = function(options) {
	      RangeView.__super__.initialize.call(this, options);
	      __.extend(this, __.pick(options, _rangeOptions));
	      return this.render();
	    };

	    RangeView.prototype.render = function() {
	      var GraphView, context, h, w, xEnd, xStart, xe, xs, ye, ys;
	      w = this.pos[2] * this.xScale.scale / 100;
	      h = this.pos[3];
	      this.$el.css({
	        position: "relative",
	      ...
	      context.fillStyle = this.model.rangeColor;
	      context.strokeStyle = this.model.rangeColor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  GestureView = (function(superClass) {
	    extend(GestureView, superClass);

	    function GestureView() {
	      return GestureView.__super__.constructor.apply(this, arguments);
	    }

	    GestureView.prototype.events = {
	      mousedown: "_onMouseDown",
	      mousemove: "_onMouseMove",
	      mouseup: "_onMouseUp"
	    };

	    GestureView.prototype.initialize = function(options) {
	      this._mouseMoving = false;
	      this._lastMousePos = void 0;
	      __.bindAll(this, "_onMouseDown", "_onMouseMove", "_onMouseUp");
	      ...
	      return $(document).on('dragend', (function(_this) {
	        return function(event) {
	          return _this._onMouseUp(event);
	        };
	      })(this));
	    ...
	    GestureView.prototype._onMouseDown = function(event) {
	      var mousePos;
	      mousePos = this._getMousePos(event);
	      this._mouseMoving = false;
	      return this.collection.selectCurrentGesture(mousePos.currentPos.x, mousePos.currentPos.y);
	    };

	    GestureView.prototype._onMouseMove = function(event) {
	      var mousePos;
	      mousePos = this._getMousePos(event);
	      if (this._mouseMoving === false) {
	        this.collection.moveStart(mousePos);
	        this._mouseMoving = true;
	      } else {
	        this.collection.move(mousePos);
	      }
	      return document.body.style.cursor = this.collection.getCursor(mousePos.currentPos.x, mousePos.currentPos.y);
	    };

	    GestureView.prototype._onMouseUp = function(event) {
	      var mousePos;
	      mousePos = this._getMousePos(event);
	      if (this._mouseMoving === false) {
	        this.collection.click(mousePos);
	      } else {
	        this.collection.moveEnd(mousePos);
	      }
	      this.collection.deselectCurrentGesture();
	      return document.body.style.cursor = this.collection.getCursor(mousePos.currentPos.x, mousePos.currentPos.y);
	    };

	    GestureView.prototype._getMousePos = function(event) {
	      var currentPos, mousePos;
	      currentPos = this._getCurrentPos(event);
	      mousePos = {
	        currentPos: currentPos,
	        differencePos: this._getDifference(currentPos)
	      };
	      this._lastMousePos = currentPos;
	      return mousePos;
	    };

	    GestureView.prototype._getCurrentPos = function(event) {
	      var elementPos;
	      elementPos = this.$el[0].getBoundingClientRect();
	      return {
	    ...
	    GestureView.prototype._getDifference = function(currentPos) {
	      if (this._lastMousePos != null) {
	        return {
	          x: currentPos.x - this._lastMousePos.x,
	          y: currentPos.y - this._lastMousePos.y
	        };
	      }
	      return {
	        x: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  ScaleData = (function(superClass) {
	    extend(ScaleData, superClass);

	    function ScaleData() {
	      return ScaleData.__super__.constructor.apply(this, arguments);
	    }

	    ScaleData.prototype.initialize = function(options) {
	      return this.set('scale', 100);
	    };

	    ScaleData.property("title", {
	      get: function() {
	        return this.get('title');
	      }
	    });

	    ScaleData.property("scale", {
	      get: function() {
	    ...
	    ScaleData.property("adjustInterval", {
	      get: function() {
	        var result;
	        result = 1;
	        [[200, 2], [400, 5], [800, 10]].some((function(_this) {
	          return function(range) {
	            if (_this.scale < range[0]) {
	              return true;
	            }
	            result = range[1];
	            return false;
	    ...
	    ScaleData.prototype.zoomOut = function() {
	      if (this.scale <= 100) {
	        return;
	      }
	    ...
	    ScaleData.prototype.zoomIn = function() {
	      if (this.scale >= 800) {
	        return;
	      }
	      return this.scale += 50;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  OffsetData = (function(superClass) {
	    extend(OffsetData, superClass);

	    function OffsetData() {
	      return OffsetData.__super__.constructor.apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, GraphData, RangeData,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  RangeData = (function(superClass) {
	    extend(RangeData, superClass);

	    function RangeData() {
	      return RangeData.__super__.constructor.apply(this, arguments);
	    }

	    RangeData.prototype.initialize = function(options) {
	      this.set('start', 0);
	      this.set('end', 0);
	      return this.set('selected', false);
	    };

	    RangeData.property("start", {
	      get: function() {
	        return this.get('start');
	      }
	    });

	    RangeData.property("end", {
	      get: function() {
	        return this.get('end');
	      }
	    });

	    RangeData.property("selected", {
	      get: function() {
	        return this.get('selected');
	      },
	      set: function(status) {
	        return this.set('selected', status);
	      }
	    });

	    RangeData.property("rangeColor", {
	      get: function() {
	        return this.get('rangeColor');
	      }
	    });

	    RangeData.property("rangeOpacity", {
	      get: function() {
	        return this.get('rangeOpacity');
	      }
	    });

	    RangeData.property("screenStart", {
	      get: function() {
	        return this._getScreenX(this.get('start'));
	      }
	    });

	    RangeData.property("screenEnd", {
	      get: function() {
	        return this._getScreenX(this.get('end'));
	      }
	    });
	    ...
	    RangeData.prototype._getScreenX = function(graphX) {
	      var GraphView, width;
	      GraphView = __webpack_require__(11);
	      width = this.get('width') * this.get('scale').scale / 100 - GraphView.ORIGIN_OFFSET_Y;
	      return width * graphX / this.get('axis').max + this.get('offset').offset;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  AxisData = (function(superClass) {
	    extend(AxisData, superClass);

	    function AxisData() {
	      return AxisData.__super__.constructor.apply(this, arguments);
	    }

	    AxisData.prototype.initialize = function(options) {
	      return this._adjustProperty();
	    };

	    AxisData.property("max", {
	      get: function() {
	        return this.get('max');
	      },
	      set: function(max) {
	    ...
	    AxisData.property("subInterval", {
	      get: function() {
	        return this.get('subInterval');
	      },
	      set: function(subInterval) {
	        this.set('subInterval', subInterval);
	        return this._adjustProperty();
	      }
	    });

	    AxisData.property("axisColor", {
	      get: function() {
	        return this.get('axisColor');
	      }
	    });

	    AxisData.prototype._adjustProperty = function() {
	      if (this.interval < this.subInterval) {
	        return this.subInterval = this.interval;
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  RectRegion = (function() {
	    function RectRegion(_minX, _minY, _maxX, _maxY) {
	      this._minX = _minX;
	      this._minY = _minY;
	      this._maxX = _maxX;
	      this._maxY = _maxY;
	      this._checkParameter(this._minX, this._minY, this._maxX, this._maxY);
	    }

	    RectRegion.property("minX", {
	      get: function() {
	        return this._val(this._minX);
	      },
	      set: function(minX) {
	        this._checkParameter(minX, this._minY, this._maxX, this._maxY);
	        return this._minX = minX;
	      }
	    });

	    RectRegion.property("minY", {
	      get: function() {
	        return this._val(this._minY);
	      },
	      set: function(minY) {
	        this._checkParameter(this._minX, minY, this._maxX, this._maxY);
	        return this._minY = minY;
	      }
	    });

	    RectRegion.property("maxX", {
	      get: function() {
	        return this._val(this._maxX);
	      },
	      set: function(maxX) {
	        this._checkParameter(this._minX, this._minY, maxX, this._maxY);
	        return this._maxX = maxX;
	      }
	    });

	    RectRegion.property("maxY", {
	      get: function() {
	        return this._val(this._maxY);
	      },
	      set: function(maxY) {
	        this._checkParameter(this._minX, this._minY, this._maxX, maxY);
	        return this._maxY = maxY;
	      }
	    });

	    RectRegion.prototype.isInside = function(x, y) {
	      if ((this._minX != null) && x < this._val(this._minX)) {
	        return false;
	      }
	      if ((this._maxX != null) && x > this._val(this._maxX)) {
	        return false;
	      }
	      if ((this._minY != null) && y < this._val(this._minY)) {
	        return false;
	      }
	      if ((this._maxY != null) && y > this._val(this._maxY)) {
	        return false;
	      }
	      return true;
	    };
	    ...
	    RectRegion.prototype._checkParameter = function(minX, minY, maxX, maxY) {
	      ...
	      if ((minX != null) && (maxX != null) && this._val(minX) > this._val(maxX)) {
	        throw "minX muse be less than maxX";
	      }
	      if ((minY != null) && (maxY != null) && this._val(minY) > this._val(maxY)) {
	        throw "minY muse be less than maxY";
	      }
	    };

	    RectRegion.prototype._val = function(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  GestureData = (function(superClass) {
	    extend(GestureData, superClass);

	    function GestureData() {
	      return GestureData.__super__.constructor.apply(this, arguments);
	    }

	    GestureData.prototype.initialize = function(options) {};

	    GestureData.property("cursor", {
	      get: function() {
	    ...
	    GestureData.prototype.getInsideRepeatIndex = function(x, y) {
	      var result;
	      result = -1;
	      this.get('repeat').some(function(repeatRegion, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.10.0
	(function() {
	  var Backbone, GestureData, GestureDataCollection,
	    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	    hasProp = {}.hasOwnProperty;
	  ...
	  GestureDataCollection = (function(superClass) {
	    extend(GestureDataCollection, superClass);

	    function GestureDataCollection() {
	      return GestureDataCollection.__super__.constructor.apply(this, arguments);
	    }

	    GestureDataCollection.REPEAT_INTERVAL = 200;

	    GestureDataCollection.prototype.model = GestureData;
	    ...
	    GestureDataCollection.prototype.deselectCurrentGesture = function() {
	      this._stopRepeat();
	      return this._currentGesture = void 0;
	    };

	    GestureDataCollection.prototype.getCursor = function(x, y) {
	      var targetModel;
	      if (this._currentGesture != null) {
	    ...
	    GestureDataCollection.prototype._startRepeat = function(mousePos, index) {
	      this._repeatMousePos = mousePos;
